            ...
            <Grid item xs={12}>
                <Grid container direction="row">
                    ...
                    <Typography variant="body1"> The timed changes in our body follow what is called a Circadian
                        Rhythm. This internal clock is dictated by the Sun. This is why you go to bed at night, at a
                    ...
                    <Typography variant="body1">
                        ...
                        ATP </a>. It builds up throughout the day, especially when we work out. When we sleep, Adenosien
                        is cleared from the brain. Caffeinie
                        works as a stimulant by blocking adenosine receptors. There is a handful of people that have a
                        mutant adenoine receptor and can drink coffee before bed.
                        Light
                        inhibits melatonin powerfully. Cells know it is night time when melatonin is released. Some
                        people get depressed in winter, and need light therapy.
                    </Typography>
                </Grid>
                <Typography variant="h5">  &nbsp;  </Typography>
                    ...
                    <Accordion>
                        ...
                        <AccordionDetails>
                            <Typography variant="body1">When you workout has a large impact on your Circadian Rhythm.
                                Most studies of exercise are around anerobic because mice like to run. Optimal Exercise
